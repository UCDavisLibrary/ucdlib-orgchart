    ...
    */
    ...
    this.orgChart
      ...
      .nodeContent(function (d) {
        ...
        let highlightHeight = d.height + 35;
        let highlightColor = '6px solid' + d.color + '"';
        let nohighlightColor = '0px solid #E4E2E9"';

  
        return `
                  <div style="width:${d.width}px;height:${highlightHeight}px;border: ${d.data._highlighted || d.data._upToTheRootHighlighted ? highlightColor : nohighlightColor}">

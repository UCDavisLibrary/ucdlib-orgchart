 ...
 <div class="orgChart">
        <div class="org-options" style="text-align:right;margin-top:38px">
            ...
            <!-- <div class="bottom-options">
                ...
                <button title="Zoom Out" class="btn--options" @click="${this.zoomOut}">${this.icons.zoomOut}</button>
                <button title="Zoom In" class="btn--options" @click="${this.zoomIn}">${this.icons.zoomIn}</button> 
             
                <button title="Export PNG" class="btn--options" @click="${e => this.exportPDF(true)}">${this.icons.exportImage} &nbsp; Export Image</button>
            </div> -->
        </div>
